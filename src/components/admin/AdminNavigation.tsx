...
export function AdminNavigation() {
  ...
  const currentNav = NAV_LINKS.find(
    (link) => pathname === link.href || (link.href !== "/admin/overview" && pathname.startsWith(link.href))
  );
    ...
    <>
      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center justify-between border-b border-[hsl(var(--border))] px-5">
          <Link href="/admin/overview" className="flex items-center gap-2.5 cursor-pointer">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4">
          ...
          <nav className="flex flex-col gap-2">
            {NAV_LINKS.map((link) => {
              ...
              const isActive =
                pathname === link.href || (link.href !== "/admin/overview" && pathname.startsWith(link.href));
        ...
        <div className="shrink-0 border-t border-[hsl(var(--border))] p-4 bg-[hsl(var(--card)/0.4)] space-y-3">
          <div className="px-1 text-xs">
            ...
            <p className="text-[10px] text-[hsl(var(--muted-foreground))] mt-0.5">Central HQ Administration</p>
          </div>
      ...
      <header className="hidden lg:flex sticky top-0 z-30 h-16 border-b border-[hsl(var(--border))] bg-[hsl(var(--background))]/95 backdrop-blur-md px-6 sm:px-8 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right text-xs">
            <p className="font-medium text-[hsl(var(--foreground))]">{user?.name || "Administrator"}</p>
